...
import { prereqProgram, IDL } from "./programs/wba_prereq";
...
// Create our program
const program = new Program<prereqProgram>(IDL, "HC2oqz2p6DEWfrahenqdq2moUcga9c9biqRBcdK3XKU1" as Address, provider);
